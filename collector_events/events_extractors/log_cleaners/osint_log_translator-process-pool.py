"""ProcessPool OSINT log translator.

Runs one translation task per Telegram message block using ProcessPoolExecutor.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Translate OSINT log blocks with ProcessPoolExecutor.")
